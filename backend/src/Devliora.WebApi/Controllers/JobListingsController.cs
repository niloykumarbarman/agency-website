using Devliora.Application.Features.JobListings.Commands.CreateJobListing;
using Devliora.Application.Features.JobListings.Commands.DeleteJobListing;
using Devliora.Application.Features.JobListings.Commands.UpdateJobListing;
using Devliora.Application.Features.JobListings.Queries.GetAllJobListings;
using Devliora.Application.Features.JobListings.Queries.GetAllJobListingsAdmin;
using MediatR;
