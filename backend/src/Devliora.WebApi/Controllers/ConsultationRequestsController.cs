using Devliora.Application.Features.ConsultationRequests.Commands.CreateConsultationRequest;
using Devliora.Application.Features.ConsultationRequests.Commands.DeleteConsultationRequest;
using Devliora.Application.Features.ConsultationRequests.Commands.UpdateConsultationRequestStatus;
using Devliora.Application.Features.ConsultationRequests.Queries.GetAllConsultationRequests;
using MediatR;
