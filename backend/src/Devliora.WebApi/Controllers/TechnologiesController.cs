using Devliora.Application.Features.Technologies.Commands.CreateTechnology;
using Devliora.Application.Features.Technologies.Commands.DeleteTechnology;
using Devliora.Application.Features.Technologies.Commands.UpdateTechnology;
using Devliora.Application.Features.Technologies.Queries.GetAllTechnologies;
using Devliora.Application.Features.Technologies.Queries.GetAllTechnologiesAdmin;
using MediatR;
