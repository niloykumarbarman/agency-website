using Devliora.Application.Features.CaseStudies.Commands.CreateCaseStudy;
using Devliora.Application.Features.CaseStudies.Commands.DeleteCaseStudy;
using Devliora.Application.Features.CaseStudies.Commands.UpdateCaseStudy;
using Devliora.Application.Features.CaseStudies.Queries.GetAllCaseStudies;
using Devliora.Application.Features.CaseStudies.Queries.GetAllCaseStudiesAdmin;
using Devliora.Application.Features.CaseStudies.Queries.GetCaseStudyBySlug;
using MediatR;
