using Devliora.Application.Features.Testimonials.Commands.CreateTestimonial;
using Devliora.Application.Features.Testimonials.Commands.DeleteTestimonial;
using Devliora.Application.Features.Testimonials.Commands.UpdateTestimonial;
using Devliora.Application.Features.Testimonials.Queries.GetAllTestimonials;
using Devliora.Application.Features.Testimonials.Queries.GetAllTestimonialsAdmin;
using MediatR;
